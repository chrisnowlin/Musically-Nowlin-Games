/**
 * Solfege Randomizer Tool
 * Main container component for the solfege generation tool
 */
...
export function SolfegeRandomizerTool() {
  const {
    settings,
    pattern,
    ensemblePattern,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-cyan-50">
      {/* Header */}
      <header className="bg-white/80 backdrop-blur-sm border-b border-green-100 sticky top-0 z-10 print:hidden">
        <div className="max-w-[95vw] mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-green-800">Solfege Randomizer</h1>

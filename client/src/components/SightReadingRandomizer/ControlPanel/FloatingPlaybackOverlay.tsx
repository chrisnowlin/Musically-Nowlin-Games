...
export function FloatingPlaybackOverlay({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 flex flex-col">
      ...
      <div className="bg-white/95 backdrop-blur-md shadow-2xl border-t border-gray-200 px-4 py-2 flex items-center justify-between gap-4">
        {/* Left: Expand Button */}
        <Button
          variant="ghost"
          size="sm"

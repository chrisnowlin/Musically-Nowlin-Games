...
import { RhythmPattern, CountingSystem, StaffLineMode, StemDirection } from '@/lib/rhythmRandomizerV2/types';
import { renderPatternToDiv, expandBeamedGroups, NotePosition } from '@/lib/rhythmRandomizerV2/rhythmNotation';
import { getSyllableForEvent } from '@/lib/rhythmRandomizerV2/countingSyllables';
...
export function StaffNotation({
  ...
  // Measure container width on mount, resize, and layout changes
  // Use ResizeObserver for reliable width detection in grid layouts
  useEffect(() => {
    ...
    // Use ResizeObserver for layout changes (more reliable than window resize for grids)

...
const PASSIVE_ITEMS: {
  ...
  { id: 'lucky-coin', name: 'Lucky Coin', description: 'Double gold from next kill', trigger: 'On enemy defeat', emoji: '🪙', count: (p) => p.buffs.persistent.luckyCoin, armedCount: (p) => p.buffs.armed.luckyCoin },

...
test.describe('Interactive Playtest: Echo Location Challenge', () => {
  test('should allow manual inspection of Echo Location Challenge game', async ({ page }) => {
    // Navigate to game
    await page.goto('http://localhost:5175/games/echo-location-challenge');
    ...
    await page.screenshot({
      path: '.playwright-mcp/echo-location-challenge-initial.png',
      fullPage: true
    });

    console.log('\n========================================');
    console.log('INTERACTIVE PLAYTEST: Echo Location Challenge');
    console.log('========================================\n');
    ...
    if (await firstButton.isVisible()) {
      ...
      await page.screenshot({
        path: '.playwright-mcp/echo-location-challenge-started.png',
        fullPage: true
      });

...
- **Affected specs**: `game-staff-invaders` (Requirements: Note Range Configuration, Recruit Mode, Cadet Mode)
- **Affected code**:
  - `client/src/components/staff-invaders/SetupScreen.tsx` - Range preset definitions and labels
  - `client/src/components/staff-invaders/StaffCanvas.tsx` - `getNoteRange()` function with line/space filtering

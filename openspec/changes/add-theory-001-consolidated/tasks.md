...
- [ ] 1.2 Create mode definitions (theory-001Modes.ts)
...
- [ ] 1.3 Create base game component (Note Reading MasterGame.tsx)
...
- [ ] 2.1 Implement mode-specific logic (theory-001Logic.ts)

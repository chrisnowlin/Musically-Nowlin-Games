...
- [x] 1.2 Create mode definitions (theory-001Modes.ts)
...
- [x] 1.3 Create base game component (Note Reading MasterGame.tsx)
...
- [x] 2.1 Implement mode-specific logic (theory-001Logic.ts)

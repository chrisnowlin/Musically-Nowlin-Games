...
- [ ] 1.2 Create mode definitions (pitch-001Modes.ts)
...
- [ ] 1.3 Create base game component (Pitch & Interval MasterGame.tsx)
...
- [ ] 2.1 Implement mode-specific logic (pitch-001Logic.ts)

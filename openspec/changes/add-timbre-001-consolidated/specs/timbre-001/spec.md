...
### Requirement: Instrument Master Multi-Mode Game
The system SHALL provide Instrument Master as a consolidated multi-mode game with 3 distinct modes covering comprehensive timbre & instruments training for ages 5-12.

#### Scenario: Game initialization
- **WHEN** Instrument Master game loads
...
The system SHALL implement distinct gameplay mechanics for each of the 3 modes: families, types, specific-instruments.
...
The system SHALL ensure Instrument Master is accessible to all users following WCAG 2.1 AA standards across all modes.

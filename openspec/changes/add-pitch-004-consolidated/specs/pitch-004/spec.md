...
### Requirement: Scale & Mode Master Multi-Mode Game
The system SHALL provide Scale & Mode Master as a consolidated multi-mode game with 4 distinct modes covering comprehensive pitch & melody training for ages 6-12.

#### Scenario: Game initialization
- **WHEN** Scale & Mode Master game loads
...
The system SHALL implement distinct gameplay mechanics for each of the 4 modes: major-minor, modes, special-scales, scale-degrees.
...
The system SHALL ensure Scale & Mode Master is accessible to all users following WCAG 2.1 AA standards across all modes.

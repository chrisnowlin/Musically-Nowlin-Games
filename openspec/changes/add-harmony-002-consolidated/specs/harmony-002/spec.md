...
### Requirement: Chord Master Multi-Mode Game
The system SHALL provide Chord Master as a consolidated multi-mode game with 3 distinct modes covering comprehensive harmony & intervals training for ages 7-12.

#### Scenario: Game initialization
- **WHEN** Chord Master game loads
...
The system SHALL implement distinct gameplay mechanics for each of the 3 modes: triads, sevenths, extended.
...
The system SHALL ensure Chord Master is accessible to all users following WCAG 2.1 AA standards across all modes.

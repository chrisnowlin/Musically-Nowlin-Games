...
### Requirement: Consonance & Dissonance Master Multi-Mode Game
The system SHALL provide Consonance & Dissonance Master as a consolidated multi-mode game with 3 distinct modes covering comprehensive harmony & intervals training for ages 7-12.

#### Scenario: Game initialization
- **WHEN** Consonance & Dissonance Master game loads
...
The system SHALL implement distinct gameplay mechanics for each of the 3 modes: consonance, dissonance, non-chord-tones.
...
The system SHALL ensure Consonance & Dissonance Master is accessible to all users following WCAG 2.1 AA standards across all modes.

...
### Requirement: Scale Builder Multi-Mode Game
The system SHALL provide Scale Builder as a consolidated multi-mode game with 2 distinct modes covering comprehensive music theory training for ages 7-12.

#### Scenario: Game initialization
- **WHEN** Scale Builder game loads
...
The system SHALL implement distinct gameplay mechanics for each of the 2 modes: all-scales, exotic.
...
The system SHALL ensure Scale Builder is accessible to all users following WCAG 2.1 AA standards across all modes.
